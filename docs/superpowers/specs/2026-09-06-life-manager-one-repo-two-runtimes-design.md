...
- [ ] `ARCH-06` Define common job, event, effect, receipt and outbox schemas without moving existing databases. Define one canonical Financial Manager ledger contract that distinguishes personal balances/transactions, verified business revenue, costs, payouts and evidence freshness while retaining source attribution.
