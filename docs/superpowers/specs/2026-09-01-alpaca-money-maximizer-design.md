...
| L10 | Local end-to-end close — **ACTIVE** | The same loop observes, exits, and reconciles the canary; official activity proves the close fills, zero unexplained position delta, fees, and realised net P&L. Restart and acknowledgement-loss replay add zero orders. |
