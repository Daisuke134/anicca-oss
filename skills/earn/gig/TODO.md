...
The active atom is **Mercor Apply resume-fit natural production acceptance**. Lancers project
...
remaining gate is its first natural 30-minute owner terminal and live evidence that material
seniority/language/location/domain contradictions cannot be high-ranked or create low-fit human
notifications, while ready no-human work remains eligible.
