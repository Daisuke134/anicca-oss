...
| L12 | Local performance gate — **ACTIVE** | Official receipts calculate net realised/unrealised P&L, fees, slippage, drawdown, exposure, and benchmark. Net-negative or statistically unsupported results keep the `$100` cap and block capital expansion without blocking further bounded measurement. |
